...
const SOURCE_ID = "H1"; // CCTV nhà ga T1
const TARGETS = [
    { id: "H2", name: "CCTV sân đỗ ô tô" },
    { id: "H3", name: "CCTV sân đỗ tàu bay" },
    { id: "H4", name: "CCTV nhà điều hành" },
    { id: "H5", name: "CCTV nhà VIP" },
    { id: "H6", name: "CCTV kho hàng" },
];
...
async function main() {
    ...
    console.log(`Nguồn: CCTV nhà ga T1 (ID: ${SOURCE_ID}) — ${sourceItems.length} mục:`);
    ...
    console.log(`\n✅ Hoàn thành! Đã copy vào ${TARGETS.length} hệ thống CCTV.`);
    process.exit(0);
}
